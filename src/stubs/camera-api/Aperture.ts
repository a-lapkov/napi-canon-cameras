...
export class Aperture implements PropertyValue {
     ...
     * @enum {number}
     */
    static readonly AllValues: Record<'8' | '11' | '12' | '13' | '16' | '19' | '20' | '21' | '24' | '27' | '28' | '29' | '32' | '35' | '36' | '37' | '40' | '43' | '44' | '45' | '48' | '51' | '52' | '53' | '56' | '59' | '60' | '61' | '64' | '67' | '68' | '69' | '72' | '75' | '76' | '77' | '80' | '83' | '84' | '85' | '88' | '91' | '92' | '93' | '96' | '99' | '100' | '101' | '104' | '107' | '108' | '109' | '112' | '133', number> = {
        '8': 1,
        '11': 1.1,
        '12': 1.2,
        '13': 1.2,
