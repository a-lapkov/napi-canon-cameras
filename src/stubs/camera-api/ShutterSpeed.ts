...
export class ShutterSpeed implements PropertyValue {
     ...
     * @enum {number}
     */
    static readonly AllValues: Record<'16' | '19' | '20' | '21' | '24' | '27' | '28' | '29' | '32' | '35' | '36' | '37' | '40' | '43' | '44' | '45' | '48' | '51' | '52' | '53' | '56' | '59' | '60' | '61' | '64' | '67' | '68' | '69' | '72' | '75' | '76' | '77' | '80' | '83' | '84' | '85' | '88' | '91' | '92' | '93' | '96' | '99' | '100' | '101' | '104' | '107' | '108' | '109' | '112' | '115' | '116' | '117' | '120' | '123' | '124' | '125' | '128' | '131' | '132' | '133' | '136' | '139' | '140' | '141' | '144' | '147' | '148' | '149' | '152' | '155' | '156' | '157' | '160', number> = {
        '16': 30,
        '19': 25,
        '20': 20,
        '21': 20,
